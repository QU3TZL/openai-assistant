...
cl.instrument_openai(async_openai_client)
sync_openai_client = OpenAI(api_key=os.environ.get("OPENAI_API_KEY"))

# Retrieve Assistant Information
assistant = sync_openai_client.assistants.retrieve(
...
async def start_chat():
    # Create a Thread
    thread = await async_openai_client.threads.create()
...
async def main(message: cl.Message):
    ...
    oai_message = await async_openai_client.threads.messages.create(
        thread_id=thread_id,
        role="user",
    ...
    async with async_openai_client.threads.runs.stream(
        thread_id=thread_id,
